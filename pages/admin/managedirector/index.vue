    ...
    <main class="flex-1 p-4 lg:ml-64">
      <div class="p-4  rounded-lg border-gray-700">
        ...
        <nav class="flex items-center justify-between pt-4" aria-label="Table navigation">
          <span class="flex items-center px-3 h-8 leading-tight  border border-gray-300 rounded-s-lg bg-gray-800 dark:border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">
