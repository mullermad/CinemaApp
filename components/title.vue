<template>
          ...
          <div class="flex items-center space-x-4">
            <div class="flex items-center text-yellow-500">
              ...
              <svg class="w-6 h-6 ml-1" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.12 3.461a1 1 0 00.95.691h3.641c.969 0 1.371 1.24.588 1.81l-2.942 2.14a1 1 0 00-.364 1.118l1.12 3.461c.3.921-.755 1.688-1.54 1.118l-2.942-2.14a1 1 0 00-1.176 0l-2.942 2.14c-.784.57-1.838-.197-1.54-1.118l1.12-3.461a1 1 0 00-.364-1.118l-2.942-2.14c-.783-.57-.38-1.81.588-1.81h3.641a1 1 0 00.95-.691l1.12-3.461z"/>
              </svg>
            </div>
            <button 
 ...
 <!-- <router-link
      ...
      <div class="mt-12">
        ...
        <div class="flex flex-wrap gap-4 items-center">
          ...
          <div class="flex flex-col items-center">
            ...
            />
            <p class="text-lg text-white mt-2 font-semibold">{{ movie.director.name }}</p>
            <p class="text-sm text-gray-400">Director</p>
          </div>

          <!-- Stars Cards -->
          <div 
            v-for="(star, index) in movie.stars.split(',')" 
            :key="index" 
          ...
          >
            <img 
              ...
              class="w-24 h-24 object-cover rounded-full shadow-md"
            />
            <p class="text-lg text-white mt-2 font-semibold">{{ star.trim() }}</p>
      ...
      <div class="flex space-x-2 overflow-x-auto mt-8 pb-4">
        <img 
          v-for="(url, index) in movie.poster_url.slice(0)" 
          :key="index" 
          :src="url" 
          alt="Movie Thumbnail" 
