<template>
  <section class="relative w-full min-h-screen bg-cover bg-center pt-16" style="background-image: url('/path-to-your-image.jpg');">
    ...
    <div class="relative z-20 flex flex-col justify-center items-center h-full px-4 text-center">
      <div class="absolute top-4 left-4 z-30 flex flex-col items-start space-y-2">
        <h2 class="text-4xl font-bold text-white drop-shadow-lg">MOVIES IN THEATERS</h2>
        <nuxt-link to="/movies-in-theaters" class="text-white hover:underline font-semibold mt-2">SEE ALL MOVIES</nuxt-link>
      </div>
